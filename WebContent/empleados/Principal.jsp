...
<body>
	...
	<div class="row">
			...
			<div class="row mt">
				...
				<div class="custom-bar-chart">
					...
					<div class="bar">
						...
						<div class="value tooltips" data-original-title="400"
							data-toggle="tooltip" data-placement="top">10%</div>
					</div>
					<div class="bar ">
						<div class="title">FEB</div>
						<div class="value tooltips" data-original-title="300"
					...
					<div class="bar">
						...
						<div class="value tooltips" data-original-title="7.500"
							data-toggle="tooltip" data-placement="top">70%</div>
					</div>
				</div>
				<!--custom chart end-->
			</div>
      ...
      *********************************************************************************************************************************************************** -->
		...
		<div class="col-lg-3 ds">
			...
			<div class="desc">
				<div class="thumb">
					<img class="img-circle" src="assets/img/<%=resultado_consulta.getString("imagen") %>" width="35px"
						height="35px" align="">
				</div>
				<div class="details">
					<p>
						<a ><%=resultado_consulta.getString("nombres") %></a><br />
						<a ><%=resultado_consulta.getString("apellidos") %> </a><br />
						<muted><%=resultado_consulta.getString("cargo") %></muted>
					</p>
				</div>
			</div>
			<%}
	...
	<div class="text-center">
		2016-confortware <a href="Principal.jsp" class="go-top"> <i
	...
	<script type="text/javascript">
		$(document).ready(function() {
			var unique_id = $.gritter.add({
				...
				title : 'Bienvenido <%=r.getnombre()%>!!!',
				// (string | mandatory) the text inside the notification
				text : 'Este es tu espacio como empleado',
				// (string | optional) the image to display on the left
				image : 'assets/img/<%=r.getimagen()%>',
