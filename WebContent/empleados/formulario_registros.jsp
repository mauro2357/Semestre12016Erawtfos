...
<body>
 ...
 <!-- **********************************************************************************************************************************************************
	...
	<!--main content start--> <section id="main-content"> <section
		class="wrapper">
	<h3>
		<i class="fa fa-angle-right"></i> Registro de Huespedes
	</h3>
	...
	<div class="row mt">
		<div class="col-lg-12">
			<div class="form-panel">
				<h4 class="mb">
					<i class="fa fa-angle-right"></i> Datos del Huesped
				</h4>
				<form class="form-horizontal style-form" method="get">
					...
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Documento
							de Identidad</label>
						<div class="col-sm-10">
							<input type="text" class="form-control">
						</div>
					...
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Correo
							Electronico</label>
						<div class="col-sm-10">
