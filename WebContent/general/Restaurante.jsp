		...
		<div class="container">
			<div class="row">
				<div class="grid_12">
					...
					<p>Gourmet es el lugar ideal para los amantes de la buena mesa, quienes desean vivir un momento memorable. Cuenta con una ubicación privilegiada, en un entorno natural rodeado de bosques y montañas enmarcado con la mejor vista al mar.
Gourmet con 35 años en el mercado cuenta con una inigualable arquitectura y ha sido un lugar de referencia turística.
Cuenta con una excelente carta mediterránea y con una variada carta de vinos.
Tiene diferentes ambientes dentro de los cuales se destacan su Piano Bar y el salón principal que cuenta con la montaña integrada a la ambientación general del lugar. Gourmet se ha especializado en acoger personas que celebran los momentos más especiales con sus diferentes planes y paquetes para toda ocasión.</p>
				</div>
			</div>
		</div>
	</div>
				...
				<div id="touch_gallery">
					...
					<div class="grid_4">
						...
						<article>
							...
							<p>Ceviche de pescado fresco marinado en jugo de limón aromatizado con jengibre, cilantro, cebolla, pimentón y manzana verde.</p>
						</article>
					</div>
					<div class="grid_4">
						...
						<article>
							<h4>Chateaubriand</h4>
						<p>Corte de lomo a la parrilla bañado en reducción de vino tinto y tres pimientas.  Término sugerido: medio.</p>
						</article>
					</div>
					<div class="grid_4">
						...
						<article>
							...
							<p>Costillas de cerdo con miel de tamarindo, papa rústica y vegetales orientales.</p>
						</article>
					</div>
					<div class="grid_4">
						...
						<article>
							<h4>Costole</h4>	
							<p>Costillas de cordero al romero, spaghetti, espárragos y tomates cherry</p>
						</article>						
					</div>
					<div class="grid_4">
						...
						<article>
							<h4>Fettuccine</h4>
							<p>Róbalo, anillos de calamar, camarones, mejillones, langostinos, salteados al vino con salsa napolitana.</p>
						</article>
					</div>
					<div class="grid_4">
						...
						<article>
							...
							<p>Fetticine negros con camarones, anchos, cubos de tomate fresco, tomates secos y rúgula fresca.</p>
						</article>
					</div>
					<div class="grid_4">
						...
						<article>
							<h4>Gamberi</h4>
							<p>Langostinos salteados con salsa a elección al curry, con mayonesa de maracuyá o al ajillo.</p>
						</article>
					</div>
					<div class="grid_4">
						...
						<article>
							...
							<p>Láminas de lomo a la parrilla con mix de lechugas, tomate cherry, aguacate, bocconcini aderezada con aceite de oliva y vinagre balsámico.</p>
						</article>
					</div>
					<div class="grid_4">
					...
					<div class="grid_4">
						...
						<article>
							<h4>Antipasto</h4>	
							<p>Berenjenas, alcachofas, champiñones, tomates secos, pimentones marrones, bocconcini, espárragos, zanahoria baby, tomate cherry, aceitunas, tomate fresco al pesto.</p>
						</article>						
					</div>
					<div class="grid_4">
						...
						<article>
							...
							<p>Láminas de atún con mix de lechugas, tomate fresco, aguacate, bocconcini aderezada con aceite de oliva y vinagre balsámico.</p>
						</article>						
					</div>
				</div>
			</div>
